...
const QnaSubmitted = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 text-center" role="presentation">
      <h1 className="text-3xl font-semibold mb-4">Congrats! Quiz is Completed</h1>
      <img src={trophy} alt="Trophy representing achievement" className="w-1/2 h-auto mb-4" />
      <div className="font-bold text-2xl">
        <span>Your score is </span>
        <span className="text-green-600">{correct}/{total}</span>
      </div>
